  ...
  return (
      <div className="wrapper">
        ...
        <Switch>          
          ...
          <Route path="/databarang" exact component={DataBuku} />
          <Route path="/databarang/tambah" exact component={TambahBuku} />
          <Route path="/databarang/edit" exact component={EditBuku} />
